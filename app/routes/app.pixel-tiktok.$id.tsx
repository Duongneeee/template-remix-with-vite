...
export default function PixelForm() {
  ...
  const _getBussinessSource = useCallback(async (_tokenFb: string) => {
    ...
    if (res.isSuccessful == true) {
      ...
      // setFormState({ ...formState, adsAccountId: mapViewAccount(res)[0].value });
  ...
  useEffect(() => {
    if(response?.isSuccessful){
      const element:any = document.getElementById('my-save-bar');
      element.hide();
      navigate(`/app/pixel-manager?isPixelSuccessful=${formData?.pixelData ? false : true}&tiktok=true`);
    }
        ...
        secondaryActions={[
          {
            ...
            onAction: () => navigate("/app/pixel-manager"),
          },
        ]}
      >
        <Modal.Section>
                  ...
                  <BlockStack>
                    {formData?.accessTokenFb && errorCodeFb === 200 ?
                      ...
                      <div className="max-w-[400px]">
                        <button type="button" className="transition ease-in-out delay-150 bg-blue-500 hover:-translate-y-1 hover:scale-110 duration-300  text-white font-bold rounded-lg text-sm px-5 py-2.5 me-2 mb-2" onClick={handleLogout}>Logout Facebook</button>
                      </div>
                      :
                      <div className="max-w-[400px]">
                        <FacebookLoginComp
                    ...
                    <div className="bg-blue-100 rounded-md w-1/2">
                      <ResourceList
                        resourceName={{
                          singular: "customer",
                          plural: "customers",
              ...
              <BlockStack>
                {formState.mode === "manual" ? (
                  <div className="flex flex-col gap-3">
                    <BlockStack>
                      <TextField
                        ...
                        label={
                          <div>
                            <strong>Tiktok Pixel ID</strong>
                            <span className="text-red-700">
                              {" "}
                              {"*"}
                              <Link
                                url={videoConfig.setupTiktokPixel}
                                target="_blank"
                              >
                                {" "}
                                How to get it?{" "}
                        ...
                        placeholder="Get the pixel ID from Tiktok, then copy and paste it here."
                      />
                      {/* {error?.errorCode == "409" && (
                        <InlineError
                          message={ || ""}
                  ...
                  (<div className="flex flex-col gap-3">
                    ...
                    <BlockStack>
                      <Select
                        label={<strong>Select Tiktok Pixel ID</strong>}
                      ...
                      <TextField
                        ...
                        label={
                          formState.isActiveCApi ? (
                            <div>
                              <strong>Tiktok Access Token</strong>
                              <span className="text-red-700">
                                {" "}
                                {"*"}{" "}
                                <Link
                                  url={videoConfig.generateAccessTokenTiktok}
                                  target="_blank"
                                >
                                  {" "}
                                  How to get it?{" "}
                            ...
                            <TextField
                              ...
                              <div>
                                <div className=" flex justify-between gap-3">
                                  <Text as="p">Use this if you need to test Server-Side Events. Please remove it after testing. <Box as="span" color="text-critical">If you don't remove it, TikTok will not store your events.</Box></Text>
                              ...
                              label={
                                <span>
                                  ...
                                  <Link
                                    url={videoConfig.testEventCodeTiktok}
                                    target="_blank"
                                  >
                                    {" "}
                                    How to get it?{" "}
